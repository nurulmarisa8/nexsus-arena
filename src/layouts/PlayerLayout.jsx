...
export default function PlayerLayout() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: '#060d1f', overflow: 'hidden' }}>
      {/* Sidebar */}
      <aside style={{
        width: 250, flexShrink: 0, background: '#0d1f3c', // slightly lighter navy for sidebar
          ...
          {navItems.map(({ icon: Icon, label, to }) => (
            <NavLink
              ...
              style={({ isActive }) => ({
                ...
                borderRadius: '0', // Square edges like the design
